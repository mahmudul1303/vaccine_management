...
class _OthersPageState extends State<OthersPage> {
  final otherlist = Others.ganaratedList();
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) => Container(
                    decoration: BoxDecoration(
                        color: Color(0xffF5A9F2), border: Border.all(width: 3)),
                    child: Column(
                      children: [
                        Stack(
                          children: [
                            Container(
                              ...
                              child: Image.asset(otherlist[index].pic),
                            ),
                            Positioned(
                              top: 5,
                              left: 140,
                              child: IconButton(
                                  onPressed: () {
                                    setState(() {
                                      otherlist[index].isChoice =
                                          !otherlist[index].isChoice;
                                    });
                                  },
                                  icon: Icon(
                                    Icons.favorite,
                                    color: otherlist[index].isChoice == true
                                        ? Colors.red
                                        : Colors.yellow,
                                  )),
                            ),
